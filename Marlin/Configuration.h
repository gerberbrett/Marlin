...
#define STRING_CONFIG_H_AUTHOR "(Brett Gerber)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_GEN_L //BG
#endif
...
//#define CUSTOM_MACHINE_NAME "ARTILLERY X-1" //BG
 ...
 */
#define X_DRIVER_TYPE  TMC2100 //BG
#define Y_DRIVER_TYPE  TMC2100 //BG
#define Z_DRIVER_TYPE  TMC2100 //BG
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2100 //BG
...
#define E0_DRIVER_TYPE TMC2100 //BG
...
#define HEATER_0_MAXTEMP 290 //BG
#define HEATER_1_MAXTEMP 290 //BG
#define HEATER_2_MAXTEMP 290 //BG
#define HEATER_3_MAXTEMP 290 //BG
#define HEATER_4_MAXTEMP 290 //BG
#define HEATER_5_MAXTEMP 290 //BG
#define HEATER_6_MAXTEMP 290 //BG
#define HEATER_7_MAXTEMP 290 //BG
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  19.87 //BG
    #define DEFAULT_Ki   1.54 //BG
    #define DEFAULT_Kd  63.88 //BG
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  49.12 //BG
  #define DEFAULT_bedKi   7.22 //BG
  #define DEFAULT_bedKd 222.66 //BG
...
#define X_MIN_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop. //BG
#define Y_MIN_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop. //BG
...
#define DETECT_BROKEN_ENDSTOP //BG
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 445 } //BG
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 50, 40 } //BG
 ...
 */
#define DEFAULT_ACCELERATION          800     // X, Y, Z and E acceleration for printing moves        //BG
#define DEFAULT_RETRACT_ACCELERATION  10000   // E acceleration for retracts                          //BG
#define DEFAULT_TRAVEL_ACCELERATION   2000    // X, Y, Z acceleration for travel (non printing) moves //BG
 ...
 */
#define S_CURVE_ACCELERATION //BG
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, -33, 0 } //BG

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 25 //BG

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (12*60) //BG

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 3) //BG
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   15 // Z Clearance for Deploy/Stow           //BG
#define Z_CLEARANCE_BETWEEN_PROBES  5 // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     5 // Z Clearance between multiple probes
#define Z_AFTER_PROBING            15 // Z position after probing is done      //BG
...
#define INVERT_Y_DIR false //BG
#define INVERT_Z_DIR true  //BG
...
#define X_BED_SIZE 310 //BG
#define Y_BED_SIZE 310 //BG
...
#define AUTO_BED_LEVELING_BILINEAR //BG
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //BG
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5    // Don't use more than 7 points per axis, implementation limited. //BG
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define HOMING_FEEDRATE_MM_M { (60*60), (60*60), (12*60) } //BG
...
//#define SKEW_CORRECTION
  ...
  //#define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_SKEW_FACTOR 0.0 //BG
    #define YZ_SKEW_FACTOR 0.0 //BG
  #endif
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 //BG
